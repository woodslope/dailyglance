...
const appSourceNoInit = `${appLifecycleSource}\n${settingsSource}\n${stripInit(refreshControllerSource)}`;
const coreDataSource = read('assets/js/02-data.js');
const observationDataSource = read('assets/js/02-observation-data.js');
const dataSource = `${coreDataSource}\n${observationDataSource}`;
