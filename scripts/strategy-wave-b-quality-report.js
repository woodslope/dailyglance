    ...
    const report = {
        ...
        sourceSnapshot: {
            hash: stableHash({
                ...
                calculationsExplain: hashFile(path.join(ROOT, 'assets/js/03-explain.js')),
                calculationsSummary: hashFile(path.join(ROOT, 'assets/js/03-summary.js')),
                calculationsWaveRegime: hashFile(path.join(ROOT, 'assets/js/03-wave-regime.js')),
                calculationsWaveRejection: hashFile(path.join(ROOT, 'assets/js/03-wave-rejection.js')),
                calculationsDecision: hashFile(path.join(ROOT, 'assets/js/03-decision.js')),
